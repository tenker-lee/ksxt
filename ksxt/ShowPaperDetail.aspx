<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPaperDetail.aspx.cs" Inherits="ksxt.ShowPaperDetail" %>
                    ...
                    <asp:Repeater ID="repChoice" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" data-options="readonly:true" style="width: 30px; margin: 2px 2px 2px 2px;" id="choice_<%#Eval("tid") %>_<%=user_id %>_score"  <%=grade?"type=\"text\"":"type=\"hidden\"" %>   value="<%# Eval("score") %>"/>
                    ...
                    <asp:Repeater ID="repJudge" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" data-options="readonly:true" style="width: 30px; margin: 2px 2px 2px 2px;" id="judge_<%# Eval("tid") %>_<%=user_id %>_score" <%=grade?"type=\"text\"":"type=\"hidden\"" %> value="<%# Eval("score") %>"/>
                    ...
                    <asp:Repeater ID="repFilling" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" data-options="readonly:true"  style="width: 30px; margin: 2px 2px 2px 2px;" id="filling_<%# Eval("tid") %>_<%=user_id %>_score"  <%=grade?"type=\"text\"":"type=\"hidden\"" %> value="<%# Eval("score") %>" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <asp:Repeater ID="repQa" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" data-options="readonly:true" style="width: 30px; margin: 2px 2px 2px 2px;" id="qa_<%# Eval("tid") %>_<%=user_id %>_score"    <%=grade?"type=\"text\"":"type=\"hidden\"" %> value="<%# Eval("score") %>" />
