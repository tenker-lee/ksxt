<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamPaper.aspx.cs" Inherits="ksxt.ExamPaper" %>
                    ...
                    <asp:Repeater ID="repFilling" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td rowspan="2" style="text-align: center"><%# Eval("id") %></td>
                                <td><%# Eval("title") %></td>
                                <td>&nbsp<%#fillingHtml(int.Parse(Eval("tid").ToString()),int.Parse(user_id),Eval("answer_arry").ToString(),Eval("value").ToString())%> 
                                </td>
                                <td>
